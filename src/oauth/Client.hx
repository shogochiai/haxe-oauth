...
class Client {
	...
	public function getAccessToken2 (uri:String, code:String, redirectUri:String, ?post:Bool = true):Client {
		...
		var ret : Dynamic = requestJSON(uri, post, json);
		var result = jsonToMap(ret);

		// このエラーにかからないので、それ以前の問題っぽい
